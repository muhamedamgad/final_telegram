...
class OnMobileData extends StatefulWidget {
  @override
  _OnMobileDataState createState() => _OnMobileDataState();
}

class _OnMobileDataState extends State<OnMobileData> {
  bool _value = false;
      ...
      body: Column(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text(
              'Voice messages are tiny , so they are always downloaded automatically.',
              style: TextStyle(
